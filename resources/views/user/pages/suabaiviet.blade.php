...
<head>
    ...
    <title>Tin tức 24h - Member Sửa bài</title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" ><marquee> Member - Sửa bài </marquee></a>
            </div>
            <!-- /.navbar-header -->
    ...
    <form action="{{ route('suabai',$tintuc_edit->id) }}" enctype="multipart/form-data" method="POST">
